...
import static spark.Spark.*;
    ...
    public class App {
        ...
        public static void main(String[] args) {
            ...
            //ranger
//            Spark.get("/create/ranger",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//                return new ModelAndView(model,"ranger-form.hbs");
//            },new HandlebarsTemplateEngine());
//            Spark.get("/view/rangers",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
//                model.put("rangers",Rangers.all());
//                return new ModelAndView(model,"ranger-view.hbs");
//            },new HandlebarsTemplateEngine());
//            Spark.get("/view/ranger/sightings/:id",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//
//            Spark.get("/view/ranger/delete/:id/d",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//            //location
//            Spark.get("/create/location",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//            },new HandlebarsTemplateEngine());
//
//            Spark.get("/view/location/delete/:id/d",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//
//            Spark.get("/view/locations",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
//                model.put("locations",Locations.all());
//                return new ModelAndView(model,"location-view.hbs");
//            },new HandlebarsTemplateEngine());
//
//            Spark.get("/view/location/sightings/:id",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//            //animal
//            Spark.get("/create/animal",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//
//            Spark.get("/create/animal/endangered",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//            },new HandlebarsTemplateEngine());
//
//            Spark.get("/view/animals",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
...
//
//            //sighting
//            Spark.get("/create/sighting",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
//                model.put("rangers",Rangers.all());
//                model.put("locations",Locations.all());
//                model.put("animals",Animals.all());
...
//            },new HandlebarsTemplateEngine());
//
//            Spark.get("/view/sightings",( request, response) -> {
//                Map<String,Object> model=new HashMap<String, Object>();
